...
- Generated: 2026-02-26T21:40:32.066Z
...
## Top similarity pairs (local -> merged)
- score=0.471 | REG-011 -> P107-058 | Which Category of small unmanned aircraft must have an airworthiness certificate issued by the FAA?
- score=0.471 | REG-157 -> P107-022 | What is the minimum flight visibility required for a remote pilot operating under Part 107 (unless otherwise authorized)
- score=0.400 | WX-035 -> P107-023 | When operating a small UAS near clouds, what are the minimum distance requirements under 14 CFR Part 107?
- score=0.350 | REG-148 -> P107-025 | According to 14 CFR part 107, what is the maximum altitude a small UAS is permitted to fly above ground level without a 
- score=0.348 | AIR-054 -> P107-100 | On a sectional chart, what does a magenta vignette (shaded area) around an airport indicate?
- score=0.320 | REG-010 -> P107-054 | To conduct Category 1 operations, a remote pilot in command must use a small unmanned aircraft that weighs
- score=0.293 | REG-155 -> P107-045 | When is a Remote ID broadcast module required for a Part 107 operation?
- score=0.282 | REG-149 -> P107-073 | After receiving a Part 107 remote pilot certificate with a small UAS rating, how often must you complete recurrent train
- score=0.250 | REG-009 -> P107-058 | Where must a small unmanned aircraft's serial number be listed when using either standard remote identification or a bro
